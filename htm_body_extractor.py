...
class BodyExtractor(object):
    ...
    def __init__(self, url, html_folder):
        self.url = url
    ...
    def _pre_process(self):
        ...
        self.html_title = soup.title.string.replace(" ", "")
    ...
    def dumpimages(self):
        ...
        out_folder = "".join([self.html_folder, "photo/"])
    ...
    def dumphtml(self):
        ...
        html_file = "".join([self.html_folder, self.html_title])
...
if __name__ == "__main__":
    ...
    url = 'http://sports.sina.com.cn/o/2015-04-01/22087561799.shtml'
